...
public class WebDriverUtility {
	 ...
	 * the control if element available
	 * 
	 * @param driver
	 */
	...
	/**
	 * it's an Explicitly wait Always wait for Page to be loaded & available in
	 * GUI
	 * 
	 * @param driver
...
//		}
	...
	/**
	 * used to select the value from the dropDwon based on value / option
	 * avlaible in GUI
	 * 
	 * @param element
	 * @param value
